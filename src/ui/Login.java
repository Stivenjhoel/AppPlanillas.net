...
public class Login extends JFrame {
	...
	public Login() {
		...
		txtPasswordd.addFocusListener(new FocusAdapter() {
		    @Override 
		    public void focusGained(FocusEvent e) {
		        txt_focusGained(txtPasswordd);
		    }
		    @Override 
		    public void focusLost(FocusEvent e) {
		        txt_focusLost(txtPasswordd);
		    }
		});
	...
	protected void btnIniciar_actionPerformed() {
		...
		if (sDni.length()<txtDni.getColumns()||
			...
			JOptionPane.showMessageDialog(this, "Dni y/o conrtraseña inálido");
			return;
		}
		...
		if ( empleadoDAO.Login( empleado)){
			...
			btnCancelar_actionPerformed();
			JOptionPane.showMessageDialog(this, "Dni y/o contraseña invalido");
		}
	}
